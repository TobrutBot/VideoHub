...
function App() {
  ...
  const videos: Video[] = [
    ...
    { videoUrl: "https://hlsvidiobucket.s3.ap-southeast-2.amazonaws.com/original/vidio13.mp4", hlsUrl: "https://hlsvidiobucket.s3.ap-southeast-2.amazonaws.com/hls/vidio13/vidio13.m3u8" }
  ];
